...
ActiveRecord::Schema.define(version: 20150629162714) do
  ...
  create_table "docestados", force: :cascade do |t|
    t.string   "nombre"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "movacciones", force: :cascade do |t|
    t.string   "nombre"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "userasignaciones", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "area_id"
    t.boolean  "es_jefe"
    t.datetime "created_at", null: false
  ...
  add_index "userasignaciones", ["area_id"], name: "index_userasignaciones_on_area_id", using: :btree
  add_index "userasignaciones", ["user_id"], name: "index_userasignaciones_on_user_id", using: :btree
